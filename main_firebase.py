...
def main() -> None:
    ...
    persistence = FirebasePersistence(database_url='URL', credentials=credentials)
    updater = Updater("1683584918:AAEuYuU8uztDiI3KOW24_QKnAx3eOP1dRUs", persistence=persistence)
